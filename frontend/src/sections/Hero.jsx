...
const Hero = () => {
  ...
  return (
    <section id="home" className="w-full flex flex-col justify-center min-h-screen gap-10  max-container xl:flex-row ">
            ...
            <div className="flex justify-start items-start flex-wrap w-full mt-20 gap-16">
                {statistics.map((stat, index) => (
                    <div key={index}>
                        ...
                        <p className="leadng-7 font-montserrat text-slate-gray">{stat.label}</p>
                    </div>
                ))}
            </div>
